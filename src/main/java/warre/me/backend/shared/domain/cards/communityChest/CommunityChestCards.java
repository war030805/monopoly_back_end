package warre.me.backend.shared.domain.cards.communityChest;
    ...
    private static Map<CardSpecificType, Card> makeCards() {
        return Stream.of(
                        ...
                        new GoToPlaceCard("Advance to \"Go\". (Collect $200)",
                                ADVANCE_TO_GO_COLLECT_200, 0, false, DeckType.COMMUNITY_CHEST),

                        // Bank error in your favor. Collect $200.
                        new MoneyTransactionCard("Bank error in your favor. Collect $200.",
                                BANK_ERROR_IN_YOUR_FAVOR_COLLECT_200, 200, false, DeckType.COMMUNITY_CHEST),

                        // Doctor's fees. Pay $50.
                        new MoneyTransactionCard("Doctor's fees. Pay $50.",
                                DOCTORS_FEES_PAY_50, 50, true, DeckType.COMMUNITY_CHEST),

                        // From sale of stock you get $50.
                        new MoneyTransactionCard("From sale of stock you get $50.",
                                SALE_OF_STOCK_COLLECT_50, 50, false,DeckType.COMMUNITY_CHEST),

                        // Get Out of Jail Free.
                        new GetOutOfJailCard("Get Out of Jail Free.", DeckType.COMMUNITY_CHEST),

                        // Go to Jail...
                        new GoToPlaceCard("Go to Jail. Go directly to Jail. Do not pass Go, Do not collect $200.",
                                GO_TO_JAIL, -1, true, DeckType.COMMUNITY_CHEST),

                        // Grand Opera Night. Collect $50 from every player.
                        new PayEachPlayerCard("Grand Opera Night. Collect $50 from every player.",
                                GRAND_OPERA_NIGHT_COLLECT_50_FROM_EACH_PLAYER, 50, DeckType.COMMUNITY_CHEST),

                        // Holiday Fund matures. Collect $100.
                        new MoneyTransactionCard("Holiday Fund matures. Collect $100.",
                                HOLIDAY_FUND_MATURES_COLLECT_100, 100, false, DeckType.COMMUNITY_CHEST),

                        // Income tax refund. Collect $20.
                        new MoneyTransactionCard("Income tax refund. Collect $20.",
                                INCOME_TAX_REFUND_COLLECT_20, 20, false, DeckType.COMMUNITY_CHEST),

                        // It's your birthday. Collect $10 from every player.
                        new PayEachPlayerCard("It is your birthday. Collect $10 from every player.",
                                ITS_YOUR_BIRTHDAY_COLLECT_10_FROM_EACH_PLAYER, 10, DeckType.COMMUNITY_CHEST),

                        // Life insurance matures. Collect $100.
                        new MoneyTransactionCard("Life insurance matures. Collect $100.",
                                LIFE_INSURANCE_MATURES_COLLECT_100, 100, false, DeckType.COMMUNITY_CHEST),

                        // Hospital Fees. Pay $50.
                        new MoneyTransactionCard("Hospital Fees. Pay $50.",
                                HOSPITAL_FEES_PAY_50, 50, true, DeckType.COMMUNITY_CHEST),

                        // School fees. Pay $50.
                        new MoneyTransactionCard("School fees. Pay $50.",
                                SCHOOL_FEES_PAY_50, 50, true, DeckType.COMMUNITY_CHEST),

                        // Receive $25 consultancy fee.
                        new MoneyTransactionCard("Receive $25 consultancy fee.",
                                CONSULTANCY_FEE_COLLECT_25, 25, false, DeckType.COMMUNITY_CHEST),
                        ...
                        new MoneyTransactionCard("You have won second prize in a beauty contest. Collect $10.",
                                BEAUTY_CONTEST_SECOND_PRIZE_COLLECT_10, 10, false, DeckType.COMMUNITY_CHEST),
